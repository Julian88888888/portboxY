    ...
    <div className="w-layout-hflex mainheader">
      <div className="headerbar">
        ...
        <div className="flex_wrapper flex_center">
          {isAuthenticated ? (
            <>
              <span className="button_icon">Welcome, {user?.firstName || 'User'}!</span>
              <a href="#" onClick={(e) => { e.preventDefault(); handleLogout(); }} className="button_icon accent_button">Logout</a>
            </>
          ) : (
            <>
              <a href="#" onClick={(e) => { e.preventDefault(); openLoginModal(); }} className="button_icon">Login</a>
              <a href="#" onClick={(e) => { e.preventDefault(); openSignUpModal(); }} className="button_icon accent_button">Sign Up</a>
            </>
          )}
        </div>
      </div>
